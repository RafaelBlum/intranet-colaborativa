                    ...
                    <div class="main-card mb-3 card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <h3 class="text-black-50 font-weight-bold animated bounce infinite">{{$unidade->titulo}}</h3>

                                <p>{{$unidade->descricao}}</p>
                                <span class="description"><i class="far fa-clock"></i> Criada em - {{ date('d/m/yy H:II', strtotime($unidade->created_at)) }}</span>
                                <hr/>
                                <div class="footer">
                                    @can('app.dashboard')
                                    ...
                                    <a type="button" class="btn btn-md btn-danger rounded" href="{{route('unidade.index')}}">
                                            <span class="btn-icon-wrapper pr-2 opacity-7">
